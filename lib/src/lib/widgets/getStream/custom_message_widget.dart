...
class CustomMessageWidget extends StatefulWidget {
  ...
  CustomMessageWidget({
    ...
    The CustomMessageWidget now listens for read events on its own.
    ''') this.allRead = false,
    @Deprecated('''
  ...
  /// Creates a copy of [CustomMessageWidget] with specified attributes overridden.
  CustomMessageWidget copyWith({
    Key? key,
...
class _MessageWidgetState extends State<CustomMessageWidget>
    with AutomaticKeepAliveClientMixin<CustomMessageWidget> {
